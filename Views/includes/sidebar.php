          ...
          <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                 ...
                 <li class="menu-item">
                  <a href="listedesarticles" class="menu-link">
                    <div data-i18n="Without menu">Tous les aticles</div>
                  </a>
                </li>  
              </ul>
            </li>
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="admn-tous-partenaires" class="menu-link" target="_blank">
                    <div data-i18n="Basic">tous nos partenaires  </div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Equipe</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="adm-modification-de-la-baniere" class="menu-link">
                    <div data-i18n="Without menu">Baniere</div>
                  </a>
                </li>
                    <li class="menu-item">
