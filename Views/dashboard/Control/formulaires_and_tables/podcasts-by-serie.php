...
?>
              ...
              <div class="table-responsive text-nowrap">
                <div class="row container">
                  <div class="col-8 pt-4">
                    <H4 style="margin-left:-12px;"> PODCASTS / <span class='text-muted fw-light'>EPISODES
                      </span></H4>
                  </div>
    ...
    while ($all =  $recup_data -> fetch()){
      ...
      ?>
                    ...
                    <tr>
                      <td class="w">
                        <?php echo "<div class='form-check form-control-sm footer-link m'>
                        <input class='form-check-input' type='checkbox' value='' id='' customCheck2' >

                      </div>"?>
                      </td>
                      <td> <b><i>
                            <?php echo substr($data['theme'],0,35); echo" ..." ;?>
                          </i></b></td>
                      ...
                      <td>
                        <a href="updatepodcast?podcast=<?php echo $data['id'];?>&?parent=<?php echo $data['parent'];?>">
                          <button class="btn btn-primary btn-sm rounded-pill" style="color:white; font-weight:bold;">
                            Modifier </button>
                        </a>
                        <a href="podcast-new?parent=<?=$data['id'];?>">
                          <button class="btn btn-secondary btn-sm rounded-pill"
                            style="color:white; font-weight:bold;">Ajouter une épisode à la serie</button>
                        </a>
                      </td>
                    </tr>
                    <?php endforeach ?>
            ...
            <div class="table_foot row">
              <div class="grouped_actions col-5" style="visibility:;">
                <b> Actions groupées : </b>
